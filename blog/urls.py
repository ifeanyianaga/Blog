...
import uuid
from .views import Blog_post_list_view,PostLikeToggle,PostLikeDB,PostLikeUsers,PostLikeColor
...
urlpatterns = [
	...
	path('<str:slug>/getLikeColor/',PostLikeColor.as_view(), name="getColorLike"),
